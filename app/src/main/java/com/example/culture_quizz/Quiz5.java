...
public class Quiz5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference questionRef= FirebaseDatabase.getInstance().getReferenceFromUrl("https://culturequizz-c2000-default-rtdb.firebaseio.com/questions/question5");
        questionRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    TextView questionTextView = findViewById(R.id.question5);
                    ...
                    for (int i = 0; i < optionsList.size(); i++) {
                        RadioButton radioButton = new RadioButton(Quiz5.this);
    ...
    private void goToNextQuestion() {
        Intent nextQuizIntent = new Intent(getApplicationContext(), Score.class);
